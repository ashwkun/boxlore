...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 1 | 32,810 | 0 |
|  | `refresh-charts` | 1 | 0 | 0 |
|  | `sync-episodes` | 1 | 1,008 | 2,016 |
|  | `vectorize-episodes` | 1 | 37,215 | 258 |
|  | `vectorize-shows` | 1 | 20,091 | 0 |
| | **Day total** | | **91,124** | **2,274** |
