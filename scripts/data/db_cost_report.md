...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 6 | 224,802 | 3,965 |
|  | `refresh-charts` | 3 | 81,734 | 57,570 |
|  | `sync-episodes` | 6 | 50,722 | 4,782 |
|  | `vectorize-episodes` | 6 | 208,000 | 3,919 |
|  | `vectorize-shows` | 5 | 98,220 | 923 |
| | **Day total** | | **663,478** | **71,159** |
