...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 3 | 112,401 | 3,965 |
|  | `refresh-charts` | 2 | 81,734 | 57,570 |
|  | `sync-episodes` | 3 | 49,953 | 3,244 |
|  | `vectorize-episodes` | 3 | 109,954 | 2,110 |
|  | `vectorize-shows` | 2 | 42,057 | 923 |
| | **Day total** | | **396,099** | **67,812** |
