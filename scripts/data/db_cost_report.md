...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 3 | 107,394 | 4,570 |
|  | `refresh-charts` | 1 | 81,734 | 57,960 |
|  | `sync-episodes` | 3 | 50,677 | 4,468 |
|  | `vectorize-episodes` | 3 | 113,603 | 1,047 |
|  | `vectorize-shows` | 3 | 63,224 | 1,210 |
| | **Day total** | | **416,632** | **69,255** |
