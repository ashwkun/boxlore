...
| :--- | :--- | ---: | ---: | ---: |
| `global` | `import-podcasts` | 2 | 74,934 | 3,965 |
|  | `refresh-charts` | 1 | 81,734 | 57,570 |
|  | `sync-episodes` | 2 | 49,891 | 3,120 |
|  | `vectorize-episodes` | 2 | 71,950 | 863 |
|  | `vectorize-shows` | 2 | 42,057 | 923 |
| | **Day total** | | **320,566** | **66,441** |
