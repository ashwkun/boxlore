...
try {
    const vocabJson = execSync(`sqlite3 "${OUTPUT_DB_PATH}" -json "SELECT term FROM search_vocab WHERE length(term) >= 4 ORDER BY doc DESC LIMIT 40000;"`, { encoding: 'utf-8', maxBuffer: 1024 * 1024 * 100 }).trim();
    if (vocabJson) {
