                            ...
                            modifier = Modifier
                                ...
                                .clickable {
                                    scope.launch {
                                        ...
                                        if (isEnabled) {
                                            cx.aswin.boxcast.core.data.SmartDownloadManager.schedulePeriodicSync(context, wifiOnly = nextVal, chargingOnly = chargingOnly)
                                        }
                                    }
                                }
                                .padding(16.dp),
                            ...
                            Switch(
                                ...
                                onCheckedChange = { checked ->
                                    scope.launch {
                                        ...
                                        if (isEnabled) {
                                            cx.aswin.boxcast.core.data.SmartDownloadManager.schedulePeriodicSync(context, wifiOnly = checked, chargingOnly = chargingOnly)
                                        }
                                    }
                                }
                            )
                            ...
                            modifier = Modifier
                                ...
                                .clickable {
                                    scope.launch {
                                        ...
                                        if (isEnabled) {
                                            cx.aswin.boxcast.core.data.SmartDownloadManager.schedulePeriodicSync(context, wifiOnly = wifiOnly, chargingOnly = nextVal)
                                        }
                                    }
                                }
                                .padding(16.dp),
                            ...
                            Switch(
                                ...
                                onCheckedChange = { checked ->
                                    scope.launch {
                                        ...
                                        if (isEnabled) {
                                            cx.aswin.boxcast.core.data.SmartDownloadManager.schedulePeriodicSync(context, wifiOnly = wifiOnly, chargingOnly = checked)
                                        }
                                    }
                                }
                            )
