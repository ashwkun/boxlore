...
import cx.aswin.boxlore.feature.home.components.GridSkeletonItems
    ...
    Box(modifier = modifier.fillMaxSize()) {
        Column(modifier = Modifier.fillMaxSize()) {
            TopControlBar(
                ...
                onFeedbackClick = {
                    cx.aswin.boxlore.core.data.analytics.AnalyticsHelper.trackTopControlbarInteraction("feedback_clicked", "home")
                    callbacks.feed.onFeedbackClick()
                },
                onFeedbackLongClick = {
                    cx.aswin.boxlore.core.data.analytics.AnalyticsHelper.trackTopControlbarInteraction("feedback_long_clicked", "home")
                    callbacks.onForceSurveyNps()
                },
                onAvatarClick = {
                    cx.aswin.boxlore.core.data.analytics.AnalyticsHelper.trackTopControlbarInteraction("settings_clicked", "home")
                    callbacks.onNavigateToSettings?.invoke()
                },
                onAvatarLongClick = {
                    cx.aswin.boxlore.core.data.analytics.AnalyticsHelper.trackTopControlbarInteraction("avatar_long_clicked", "home")
        ...
        item(span = StaggeredGridItemSpan.FullLine, key = "your_shows", contentType = "your_shows") {
          ...
          androidx.compose.animation.Crossfade(
            ...
            when {
                ...
                showImportBanner -> {
                    LaunchedEffect(Unit) {
                        cx.aswin.boxlore.core.data.analytics.AnalyticsHelper.trackHomeImportBannerImpression()
                    }
                    HomeImportBanner(
                        onAiOnboardingClick = {
                            cx.aswin.boxlore.core.data.analytics.AnalyticsHelper.trackHomeImportBannerClicked("ai")
                            onAiOnboardingClick()
                        },
                        onSearchClick = {
                            cx.aswin.boxlore.core.data.analytics.AnalyticsHelper.trackHomeImportBannerClicked("search")
                            onNavigateToExplore?.invoke(null, "home_banner", null)
                        },
                        onImportClick = {
                            cx.aswin.boxlore.core.data.analytics.AnalyticsHelper.trackHomeImportBannerClicked("import")
                            onImportClick()
                        },
                        onDismiss = {
                            cx.aswin.boxlore.core.data.analytics.AnalyticsHelper.trackHomeImportBannerDismissed()
