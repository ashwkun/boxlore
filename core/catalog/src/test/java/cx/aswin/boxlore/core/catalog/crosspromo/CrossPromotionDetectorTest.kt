...
class CrossPromotionDetectorTest {
    ...
    fun testStrictDelimiterPattern() {
        ...
        for ((title, expectedShow) in cases) {
            ...
            println(
                "StrictDelimiter - TITLE: '$title', RESULT isCrossPromo: ${result.isCrossPromotion}, extractedShowName: '${result.extractedShowName}'",
            )
    ...
    fun testStrictPresentsPattern() {
        ...
        for ((title, expectedShow) in cases) {
            ...
            val result = detector.detect(episode, "Host Podcast")
            println(
                "StrictPresents - TITLE: '$title', RESULT isCrossPromo: ${result.isCrossPromotion}, extractedShowName: '${result.extractedShowName}'",
            )
    ...
    fun testConditionalStrictPattern() {
        ...
        for ((title, expectedShow) in cases) {
            ...
            println(
                "ConditionalStrict - TITLE: '$title' (Long) - isCrossPromo: ${resultLong.isCrossPromotion}, extractedShowName: '${resultLong.extractedShowName}'",
            )
            ...
            println(
                "ConditionalStrict - TITLE: '$title' (Short) - isCrossPromo: ${resultShort.isCrossPromotion}, extractedShowName: '${resultShort.extractedShowName}'",
            )
