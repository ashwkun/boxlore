...
* UI Fixes & Enhancements: Improved episode tagging, better layout on all screen sizes, and countless bug fixes for a smoother experience.
</en-GB>
...
* UI सुधार: बेहतर एपिसोड टैगिंग, सभी स्क्रीन्स पर शानदार लेआउट और कई बग फिक्स।
</hi-IN>
...
* Улучшения UI: Улучшены теги эпизодов, оптимизирован интерфейс для всех экранов и исправлены ошибки.
</ru-RU>
...
* Mejoras de UI: Mejores etiquetas de episodios, interfaz optimizada para todas las pantallas y corrección de errores.
</es-ES>
...
* Miglioramenti UI: Migliori tag per gli episodi, layout ottimizzato per tutti gli schermi e correzione di bug.
</it-IT>
...
* UIの改善: エピソードのタグ付けの改善、あらゆる画面サイズでのレイアウト最適化、バグ修正。
</ja-JP>
...
* UI 增强与修复：改进了单集标签，优化了全屏幕适配，并修复了诸多错误以提供更流畅的体验。
</zh-CN>
